  ...
  return (
    <div className="App">
      ...
      <select className="app-select">
          <option onClick={() => setLabel("india")}>India</option>
          <option onClick={() => setLabel("america")}>America</option>
          <option onClick={() => setLabel("china")}>China</option>
          <option onClick={() => setLabel("afghanistan")}>Afghanistan</option>
          <option onClick={() => setLabel("africa")}>Africa</option>
        </select>
